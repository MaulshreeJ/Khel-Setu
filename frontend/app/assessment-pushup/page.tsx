...
import { uploadPushupAssessment, getCurrentUser } from "@/lib/api"
import Link from "next/link"

export default function PushUpAssessmentPage() {
  ...
  const handleUpload = async () => {
    ...
    setError(null)
    try {
      const result = await uploadPushupAssessment(videoBlob)
    ...
    <div className="min-h-screen bg-background p-4 md:p-8">
      <div className="max-w-4xl mx-auto space-y-6">
        <div className="flex items-center space-x-4">
          ...
          <div>
            <h1 className="text-3xl font-bold tracking-tight">AI Push-Up Assessment</h1>
            <p className="text-muted-foreground">Record your push-ups for AI rep counting.</p>
          </div>
        </div>
              ...
              <Card>
                ...
                <CardContent className="space-y-4 text-sm text-muted-foreground">
                  <ol className="list-decimal list-inside space-y-2">
                    ...
                    <li>Get into push-up position — hands shoulder-width apart.</li>
                    <li>Ensure good lighting so the AI can see your shoulders, elbows, and wrists.</li>
                    <li>Press "Start Recording".</li>
                    <li>Perform as many push-ups as you can with good form.</li>
              ...
              <Card className="border-green-200 bg-green-50/50">
                ...
                <CardContent className="space-y-6">
                  <div className="text-center p-6 bg-white rounded-xl shadow-sm border border-green-100">
                    <div className="text-sm font-semibold text-muted-foreground uppercase tracking-wider mb-2">Push-Ups Counted</div>
                    <div className="text-6xl font-black text-green-600">{analysisResult.reps_counted}</div>
                  </div>
